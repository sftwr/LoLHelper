...
public class BoundaryValueAnalysis extends AndroidTestCase {
    //Boundary Value Analysis using the ChampionsManager and ItemsManager
    ...
    private void runInput(int position, String myResult, String myExpectedOutput){
        result = myResult;
        if (result.equals(myExpectedOutput)){
    ...
    public void testGetChampionName() throws Exception {
        ...
        for (int i = 0; i < 6; i++){
            try {
                runInput(i, myChampionsManager.getChampionName(testInput[i]), expectedOutput[i]);
...
/*        for (int i = 0; i < 6; i++){
    ...
    public void testGetItemName() throws Exception{
        ...
        for (int i = 0; i < 6; i++){
            try {
                runInput(i, myItemsManager.getItemName(testInput2[i]), expectedOutput[i]);
            } catch (IndexOutOfBoundsException iooe){
                runCatch(i);
            }
        }
    ...
    public void testGetChampionDescription() throws Exception {
        ...
        for (int i = 0; i < 6; i++){
            try {
                runInput(i, myChampionsManager.getChampionDescription(testInput[i]), expectedOutput[i]);
            } catch (IndexOutOfBoundsException iooe){
                runCatch(i);
            }
        }
